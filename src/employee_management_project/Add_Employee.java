...
class Add_Employee implements ActionListener{
    ...
    Add_Employee(){
        ...
        id15.setLayout(null);
//        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("employee_management_project/icons/add_employee.jpg"));
//        id15.setIcon(img);
...
//        String k = t11.getText();
        if(ae.getSource() == b){
            try{
                conn cc = new conn();
                String q = "insert into employee_details values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+null+"','"+null+"')";
